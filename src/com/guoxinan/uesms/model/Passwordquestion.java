...
public class Passwordquestion {
	...
	public String toString() {
		return "Passwordquestion [passwordQuestionId=" + passwordQuestionId
				+ ", passwordQuestionContent=" + passwordQuestionContent
				+ ", passwordQuestionAnswer=" + passwordQuestionAnswer
				+ ", passwordQuestionIsDeleted=" + passwordQuestionIsDeleted
				+ "]";
	}
